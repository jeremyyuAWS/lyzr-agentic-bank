...
import { ArrowRight, Shield, CreditCard, Landmark, Bot, RefreshCw, Terminal, BotMessageSquare } from 'lucide-react';
import AgentVisualization from './dashboard/AgentVisualization';
import ActivityLog from './dashboard/ActivityLog';
import AgentMetrics from './dashboard/AgentMetrics';
import AgentCommunicationFlow from './dashboard/AgentCommunicationFlow';
import DashboardStats from './dashboard/DashboardStats';
import WorkflowSummary from './dashboard/WorkflowSummary';
    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Agent Visualization - Takes 2/3 of space on large screens */}
